...
- Flughafenwahl, Runwayempfehlung, Rollstrecke, Uhrzeit und Wind stehen im
  ...
  Performanceanzeige stellt Roll- und 50-ft-Wert als zwei kompakte Blöcke dar;
  Beschriftungen und Werte verwenden dieselbe gut lesbare größere Schrift. Die
  Hindernishöhe wird als `50 ft` geschrieben. Die Rollstrecke ist von 50 bis 74 Prozent
